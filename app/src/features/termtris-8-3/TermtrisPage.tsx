            ...
            <div className="tt-page">
                <header className="tt-topbar">
                    ...
                    <div className="tt-topbar-right">
                        ...
                        <button onClick={() => navigate('/')} className="tt-btn tt-btn--ghost">← Terug</button>
                    </div>
                </header>

                <div className="tt-ready">
                    <div className="tt-ready-icon">🧱</div>
                    <h1>Termtris — §8.3</h1>
                    <p>Los vergelijkingen op en speel Tetris!</p>

                    <div className="tt-rules">
                        <div className="tt-rules-title">Spelregels</div>
                        <ul>
                            <li>⏱ 10 minuten — race tegen de klok</li>
                            ...
                            <li>🎮 ← → bewegen, ↑ draaien, ↓ snel, Spatie = drop</li>
        ...
        return (
            <div className="tt-page">
                ...
                <div className="tt-result">
                    <div className={`tt-result-card ${passed ? 'tt-result-card--pass' : 'tt-result-card--fail'}`}>
                        <div className="tt-result-icon">{passed ? '🏆' : '💪'}</div>
                        ...
                        <div className="tt-stats">
                            <div className="tt-stat">
                                <div className="tt-stat-value" style={{ color: '#a78bfa' }}>{score}</div>
                                <div className="tt-stat-label">Score</div>
                            </div>
                            <div className="tt-stat">
                                <div className="tt-stat-value" style={{ color: '#00b894' }}>{correctCount}</div>
                                <div className="tt-stat-label">Goed</div>
                            </div>
                            <div className="tt-stat">
                                <div className="tt-stat-value" style={{ color: '#f43f5e' }}>{wrongCount}</div>
                                <div className="tt-stat-label">Fout</div>
                            </div>
                            <div className="tt-stat">
                                <div className="tt-stat-value" style={{ color: '#f97316' }}>🔥{bestStreak}</div>
                                <div className="tt-stat-label">Streak</div>
                            </div>
                            <div className="tt-stat">
                                <div className="tt-stat-value" style={{ color: '#00ced1' }}>{linesCleared}</div>
                                <div className="tt-stat-label">Lijnen</div>
                            </div>
                        </div>
                        ...
                        <div className="tt-actions">
                            <button className="tt-btn tt-btn--ghost" onClick={() => navigate('/')}>← Leerpad</button>
                            <button className="tt-btn tt-btn--primary" onClick={startGame}>🔄 Nog een ronde</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="tt-page">
            ...
            <div className="tt-progress">
                <div className={`tt-progress-fill ${timeLeft <= 60 ? 'tt-progress-fill--danger' : ''}`} style={{
                    width: `${(timeLeft / TIMER_SECONDS) * 100}%`,
                }} />
            </div>

            {/* Main game layout: Field (left) + Question/HUD/LB (right) */}
            <div className="tt-game-layout">
                {/* LEFT: Field + Next preview */}
                <div className="tt-field-col">
                    <Field
                        field={field}
                ...
                <div className="tt-side-col">
                    {/* Status indicator */}
                    <div className={`tt-status ${phase === 'playing' ? 'tt-status--playing' : 'tt-status--question'}`}>
                        {phase === 'playing'
